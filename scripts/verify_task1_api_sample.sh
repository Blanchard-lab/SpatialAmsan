...
# ──────────────────────────────────────────────────────────────────────────────
# Verify Task 1 API evaluation on a small sample (1 problem).
# Runs all 3 API models, prints per-turn scores side by side.
# Usage:
#   ./scripts/verify_task1_api_sample.sh            # default: problem idx 0
#   SAMPLE_IDX=1 ./scripts/verify_task1_api_sample.sh  # pick another problem
# ──────────────────────────────────────────────────────────────────────────────
...
OUT_DIR="./results/verify_task1_sample"
mkdir -p "$OUT_DIR"

echo "============================================================"
echo " Task 1 API — Sample Verification"
